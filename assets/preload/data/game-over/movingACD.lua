...
sprite = 'AIleaves' --name of the image you want moving in the background
size = -10680 --number of pixels from left to right
startX = 0 --where you want it to be from left to right
startY = 0 --where you want it to be from bottom to top
duration = 10 --how long it takes to scroll from one side of the screen to the other
...
function onStepHit()
	if curStep >= 2341 then
		doTweenAlpha('2move2','sprite2', 0, 0.2, 'linear')
		doTweenAlpha('1move2','sprite1', 0, 0.2, 'linear')
	end
end
